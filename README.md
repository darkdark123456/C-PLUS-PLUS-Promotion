...
![Stars](https://img.shields.io/github/stars/darkdark123456/CplusplusPromotion?style=flat-square&color=yellow)
![Forks](https://img.shields.io/github/forks/darkdark123456/CplusplusPromotion?style=flat-square&color=blue)
![Watching](https://img.shields.io/github/watchers/darkdark123456/CplusplusPromotion?style=flat-square&color=green)
![Last Commit](https://img.shields.io/github/last-commit/darkdark123456/CplusplusPromotion?style=flat-square)
...
>
> 适合有一定 C++ 基础、希望深入理解语言本质与工程实践的开发者。作者持续更新中...
...
CPP --> STL[STL 容器实现]
CPP --> Template[模板扩展]
CPP --> Concurrency[多线程编程]
CPP --> Network[网络编程]
CPP --> Design[设计模式]
CPP --> CBook[C 专家编程 / 缺陷与漏洞]

Memory --> RAII[RAII]
Memory --> SmartPtr[智能指针]

Concurrency --> Mutex[互斥量]
Concurrency --> Atomic[原子操作]
Concurrency --> CondVar[条件变量]

Network --> ACE[ACE 网络编程]
Network --> UNIXNet[UNIX 网络编程]
```
...
<a href="https://github.com/darkdark123456">
  <img src="https://github.com/darkdark123456.png" width="60" style="border-radius:50%" />
</a>
